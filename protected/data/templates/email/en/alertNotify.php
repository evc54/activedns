...
return array(
  'isHtml'=>true,
  'subject'=>"{siteName}: domain alerts notification",
  'body'=>'<!DOCTYPE html>
<html>
  <head>
    <meta http-equiv="Content-Type" content="text/html; charset=UTF-8" />
    <title>{siteName} domain alerts notification</title>
  </head>
    ...
    <center>
      <table width="580" border="0" cellspacing="0" cellpadding="0" style="background-color: #f0f0f0;">
        ...
        <tr style="background-color: #3A3A3A; ">
          ...
          <td colspan="5" align="right" style="padding: 10px;"><font style="font-family: arial; font-size: 11px; color: #aaaaaa;">Domain alerts notification</font></td>
        </tr>
        <tr>
          <td colspan="10" align="left" style="padding: 25px 10px 10px;"><font style="font-family: arial; font-size: 24px;">Some of your domains alerted</font></td>
        </tr>
        <tr>
          <td colspan="10">
            <table width="580" border="0" cellspacing="0" cellpadding="0">
              <tr>
                ...
                <td align="left" style="padding: 3px 10px 3px 0; border-bottom: 1px solid #dddddd;"><font style="font-family: arial; font-size: 11px; font-weight: bold;">Alert</font></td>
              </tr>
              {alerts}
              <tr>
