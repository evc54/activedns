...
<html>
  <head>
    ...
    <title>{siteName} e-mail change notification</title>
  </head>
    ...
    <center>
      <table width="580" border="0" cellspacing="0" cellpadding="0" style="background-color: #f0f0f0;">
        ...
        <tr style="background-color: #3A3A3A; ">
          ...
          <td colspan="5" align="right" style="padding: 10px;"><font style="font-family: arial; font-size: 11px; color: #aaaaaa;">E-mail change notification</font></td>
        </tr>
        <tr>
          <td colspan="10" align="left" style="padding: 25px 10px 10px;"><font style="font-family: arial; font-size: 24px;">E-mail address has been changed</font></td>
        </tr>
        <tr>
          <td colspan="10" align="left" style="padding: 10px;"><font style="font-family: arial; font-size: 17px;">Somebody change e-mail at your {siteName} account to new address {newEmail}</font></td>
        </tr>
        <tr>
        <tr>
