...
return array(
  'isHtml'=>true,
  'subject'=>"{siteName}: подтверждение изменения адреса электронной почты",
  'body'=>'<!DOCTYPE html>
<html>
  <head>
    <meta http-equiv="Content-Type" content="text/html; charset=UTF-8" />
    <title>{siteName} подтверждение изменения адреса электронной почты</title>
  </head>
    ...
    <center>
      <table width="580" border="0" cellspacing="0" cellpadding="0" style="background-color: #f0f0f0;">
        ...
        <tr style="background-color: #3A3A3A; ">
          ...
          <td colspan="5" align="right" style="padding: 10px;"><font style="font-family: arial; font-size: 11px; color: #aaaaaa;">Изменение адреса электронной почты</font></td>
        </tr>
        <tr>
          <td colspan="10" align="left" style="padding: 25px 10px 10px;"><font style="font-family: arial; font-size: 24px;">Подтверждение нового адреса электронной почты</font></td>
        </tr>
        <tr>
          <td colspan="10" align="left" style="padding: 10px;"><font style="font-family: arial; font-size: 17px;">Кто-то отправил запрос на изменение адреса электронной почты Вашей учетной записи на сайте {siteName} на новый адрес <b>{newEmail}</b></font></td>
        </tr>
        <tr>
          <td colspan="10" align="left" style="padding: 10px;"><font style="font-family: arial; font-size: 14px;">Для подтверждения изменения адреса пожалуйста перейдите по следующей ссылке, или скопируйте ее в адресную строку Вашего браузера</font></td>
        </tr>
        <tr>
