...
return array(
  'isHtml'=>true,
  'subject'=>"{siteName}: уведомление об изменении пароля",
  'body'=>'<!DOCTYPE html>
<html>
  <head>
    <meta http-equiv="Content-Type" content="text/html; charset=UTF-8" />
    <title>{siteName} уведомление об изменении пароля</title>
  </head>
    ...
    <center>
      <table width="580" border="0" cellspacing="0" cellpadding="0" style="background-color: #f0f0f0;">
        ...
        <tr style="background-color: #3A3A3A; ">
          ...
          <td colspan="5" align="right" style="padding: 10px;"><font style="font-family: arial; font-size: 11px; color: #aaaaaa;">Пароль был изменен</font></td>
        </tr>
        <tr>
          <td colspan="10" align="left" style="padding: 25px 10px 10px;"><font style="font-family: arial; font-size: 24px;">Ваш пароль был изменен</font></td>
        </tr>
        <tr>
          <td colspan="10" align="left" style="padding: 10px;"><font style="font-family: arial; font-size: 17px;">Вы успешно изменили пароль на сайте {siteName}</font></td>
        </tr>
        <tr>
        <tr>
