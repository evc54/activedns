...
return array(
  'isHtml'=>true,
  'subject'=>"{siteName}: уведомление об удалении учетной записи",
  'body'=>'<!DOCTYPE html>
<html>
  <head>
    <meta http-equiv="Content-Type" content="text/html; charset=UTF-8" />
    <title>{siteName} уведомление об удалении учетной записи</title>
  </head>
    ...
    <center>
      <table width="580" border="0" cellspacing="0" cellpadding="0" style="background-color: #f0f0f0;">
        ...
        <tr style="background-color: #3A3A3A; ">
          ...
          <td colspan="5" align="right" style="padding: 10px;"><font style="font-family: arial; font-size: 11px; color: #aaaaaa;">Учетная запись удалена</font></td>
        </tr>
        <tr>
          <td colspan="10" align="left" style="padding: 25px 10px 10px;"><font style="font-family: arial; font-size: 24px;">Ваша учетная запись была удалена</font></td>
        </tr>
        <tr>
          <td colspan="10" align="left" style="padding: 10px;"><font style="font-family: arial; font-size: 17px;">Ваша учетная запись на сайте {siteName} была удалена по Вашему запросу</font></td>
        </tr>
        <tr>
        <tr>
