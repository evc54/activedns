...
return array(
  'isHtml'=>true,
  'subject'=>"{siteName}: уведомление об ответе",
  'body'=>'<!DOCTYPE html>
<html>
  <head>
    <meta http-equiv="Content-Type" content="text/html; charset=UTF-8" />
    <title>{siteName} уведомление об ответе</title>
  </head>
    ...
    <center>
      <table width="580" border="0" cellspacing="0" cellpadding="0" style="background-color: #f0f0f0;">
        ...
        <tr style="background-color: #3A3A3A; ">
          ...
          <td colspan="5" align="right" style="padding: 10px;"><font style="font-family: arial; font-size: 11px; color: #aaaaaa;">Уведомление об ответе</font></td>
        </tr>
        <tr>
          <td colspan="10" align="left" style="padding: 25px 10px 10px;"><font style="font-family: arial; font-size: 24px;">Вам ответили в билете №{ticket}</font></td>
        </tr>
        <tr>
          <td colspan="10" align="left" style="padding: 10px;"><font style="font-family: arial; font-size: 17px;">Пожалуйста, <a href="{loginUrl}">войдите на сайт</a> для того, чтобы прочитать ответ</font></td>
        </tr>
        <tr>
        <tr>
          <td colspan="10" align="left" style="padding: 10px;"><font style="font-family: arial; font-size: 14px;">В случае, если Вы думаете, что это ошибка, Вы можете связаться с системным оператором сайта {siteName} по следующему адресу: <a href="mailto:{adminEmail}">{adminEmail}</a></font></td>
        </tr>
        <tr>
