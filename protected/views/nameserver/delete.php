...
/**
  Project       : ActiveDNS
  Document      : views/nameserver/delete.php
  Document type : PHP script file
  Created at    : 20.10.2012
  Author        : Eugene V Chernyshev <evc22rus@gmail.com>
  Description   : Nameserver's management delete confirmation
*/
?>
<div class="container">
  <div class="row">
    <div class="span10 offset1">
      <h2><?php echo Yii::t('nameserver','Are you sure to remove nameserver?')?></h2>
    </div>
  </div>
  <div class="row">
    <div class="span10 offset1">
